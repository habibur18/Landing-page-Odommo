  ...
  return (
    <section className="bg-[#F5F5F5] py-20">
      <div className="max-w-[1350px] px-10 2xl:px-0 mx-auto">
        ...
        <div>
          <Swiper cssMode={true} navigation={{ nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" }} pagination={true} modules={[Navigation, Pagination]} className="mySwiper" style={{ overflow: "visible" }}>
            <SwiperSlide>
