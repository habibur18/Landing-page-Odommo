...
export default function SearchDomain() {
  return (
    <section className="my-20 bg">
      <div className="container mx-auto bg-[#F5F5F5] py-20">
        <div className="flex flex-col items-center space-y-10">
          ...
          <div className="flex w-full justify-center">
            <input style={{ boxShadow: "0px 4px 4px 0px #DBE9FF" }} className="text-[#B5B3B3] px-10 py-3 focus:placeholder:text-transparent focus:outline-none focus:ring-2 rounded-tl-3xl rounded-bl-3xl lg:w-1/2" type="text" placeholder="Register a domain name to start" />
