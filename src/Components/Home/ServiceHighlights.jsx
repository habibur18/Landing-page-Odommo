    ...
    <section>
      <div className="max-w-[1350px] px-10 2xl:px-0 mx-auto">
        <div className="flex flex-col-reverse lg:flex-row gap-10">
          ...
          <div className="lg:w-[70%] 2xl:w-[80%]">
        ...
        <div className="flex flex-col-reverse lg:flex-row  gap-10 2xl:gap-20 my-10 ">
          <div>
            <div>
          ...
          <div className="lg:w-3/6">
            <div className="flex gap-5 my-5">
              <div>
                <img className="w-[100px] h-[50px] sm:w-[80px] sm:h-[70px]" src="https://i.ibb.co/TcH6p2p/security.png" alt="" />
              </div>
              <div>
            ...
            <div className="flex gap-5 my-5">
              <div>
                <img className="w-[100px] h-[50px] sm:w-[80px] sm:h-[70px]" src="https://i.ibb.co/Mc1Sqjp/guarantee.png" alt="" />
              </div>
              <div>
            ...
            <div className="flex gap-5 my-5">
              <div>
                <img className="w-[80px] h-[50px] sm:w-[80px] sm:h-[70px]" src="https://i.ibb.co/7twdCZH/support.png" alt="" />
              </div>
              <div>
            ...
            <div className="flex gap-5 mt-5">
              <div>
                <img className="w-[100px] h-[50px] sm:w-[80px] sm:h-[70px]" src="https://i.ibb.co/Gxk7Gdx/reliability.png" alt="" />
              </div>
              <div>
