    ...
    <section className="my-20">
      <div className="max-w-[1350px] px-10 2xl:px-0 mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 [&>div]:sm:max-w-[389px]">
          <div className="bg-[#DADBDD7A]/[0.48] flex flex-col">
            ...
            <div className="p-5">
              ...
              <div className="space-y-4 flex flex-col">
                <Link to="/blog" className="flex-grow text-3xl font-bold">
          ...
          <div className="bg-[#DADBDD7A]/[0.48] flex flex-col">
            <figure>
              <img className="rounded-xl w-full " src="https://i.ibb.co/k3fdsBj/3.png" alt="" />
            </figure>
            <div className="p-5">
              <div className="flex justify-between">
                <p>02 January 2024</p>
              ...
              <div className="space-y-4">
                <Link to="/blog" className="text-3xl font-bold">
                  Organisational teams of the are just like families.
                </Link>
                <p className="text-xl text-[#707071]">{description.length > 130 ? description.slice(0, 130) + "..." : description}</p>
              </div>
            </div>
            <Link className="mt-auto p-5 underline underline-offset-4 font-medium" to="/blog">
              Read more
