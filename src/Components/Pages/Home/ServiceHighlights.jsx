          ...
          <div className="lg:w-3/6  space-y-5 lg:space-y-[35px]">
            <div>
              <div className="flex gap-[22px]">
                <img className="size-[50px] sm:size-[70px]" src="https://i.ibb.co/TcH6p2p/security.png" alt="" />
            ...
            <div>
              <div className="flex gap-[22px]">
                <img className="size-[50px] sm:size-[70px]" src="https://i.ibb.co/Mc1Sqjp/guarantee.png" alt="" />
                <div className="w-full 2xl:w-[60%]">
            ...
            <div>
              <div className="flex gap-[22px]">
                <img className="size-[50px] sm:size-[70px]" src="https://i.ibb.co/Gxk7Gdx/reliability.png" alt="" />
                <div className="w-full 2xl:w-[60%]">
            ...
            <div>
              <div className="flex gap-[22px]">
                <img className="size-[50px] sm:size-[70px]" src="https://i.ibb.co/7twdCZH/support.png" alt="" />
                <div className="w-full 2xl:w-[60%]">
