        ...
        <div className="my-[84px] flex md:flex-row flex-col gap-10 ">
          ...
          <form className="w-full flex-1">
            ...
            <div>
              ...
              <button className="w-48 bg-[#0198FE] hover:bg-white hover:text-[#0198FE] hover:ring-2 hover:ring-[#0198FE] duration-300 text-white px-3 py-3 sm:px-5 my-5  sm:py-4 rounded-[36px] flex justify-center gap-2" type="submit">
                Submit
              </button>
            </div>
          </form>
