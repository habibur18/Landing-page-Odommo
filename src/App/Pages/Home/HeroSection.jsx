    ...
    <section className="bg-[#E8F6FF] py-[150px]  md:py-[200px]">
      <div className=" max-w-[1350px] px-10 lg:px-[98px]  2xl:px-0  mx-auto flex md:flex-row flex-col justify-center gap-x-10 xl:gap-x-16">
        ...
        <div className="space-y-5">
          ...
          <Link onClick={() => window.scrollTo(0, 0)} to="/getstarted" className="group max-w-[250px] bg-[#0198FE] text-white px-3 py-3 sm:px-5 sm:py-4 rounded-[36px] flex justify-center gap-2 hover:bg-white hover:text-[#0198FE] hover:ring-2 hover:ring-[#0198FE] duration-300 group">
            get started now
