    ...
    <section className="">
      <div className="max-w-[1350px] px-10 2xl:px-0 mx-auto bg-[#F5F5F5] py-20 rounded-md">
        <div className="flex flex-col items-center space-y-10">
          ...
          <div>
            <button className={`${active ? "bg-[#3B82F6]" : "bg-[#AEACAC]"} text-white px-5 py-2 rounded-tl-3xl rounded-bl-3xl`} onClick={() => setActive(true)}>
              Register
            </button>
            <button className={`${!active ? "bg-[#3B82F6]" : "bg-[#AEACAC]"} text-white px-5 py-2 rounded-tr-3xl rounded-br-3xl`} onClick={() => setActive(false)}>
              Transfer
            </button>
          </div>
