      ...
      <div className="max-w-[1350px] px-10 2xl:px-0 py-20 mx-auto  bg-[#F5F5F5] rounded-md">
        <div className="space-y-5 flex justify-center flex-col items-center">
          ...
          <div className="my-10 py-4">
            <Link onClick={() => window.scrollTo(0, 0)} to="/contact-us" className="group bg-[#0198FE] text-white px-3 py-3 sm:px-5 sm:py-4 rounded-[36px] flex justify-center gap-2 hover:bg-white hover:text-[#0198FE] hover:ring-2 hover:ring-[#0198FE] duration-300 group">
              Let's Collaborate
